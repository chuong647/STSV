...
<?php 
    ...
    function Them($MaGiangVien, $HoTen, $NgaySinh, $GioiTinh, $DanToc, $SoCMND, $TonGiao, $QueQuan, $SDT, $Email, $ChucVu, $CoVanHocTap, $MatKhau)
    {
        if($MaGiangVien == "")
        {
            echo '<script>alert("Mã giảng viên không được bỏ trống!");</script>';
        }
        else
        {
            ...
            {
                echo '<script>alert("Mã giảng viên đã tồn tại!");</script>';
            }
            else
            {
                    ...
                    <div class="container-ad-items">
                        ...
                        <div>
                            <table class="tbsv">
                                <tr>
                                    <td>
                                        <h4>Mã giảng viên</h4><input class="text" type="text" name="txtMaGiangVien">
                                    </td>
                                    <td>
                                ...
                                <tr style="text-align: center;">
                                    <td colspan=3 style="text-align: center;">
                                        <input class="btn1" type="submit" name="btnThem" value="Thêm">
                                        <?php 
                                        if($_POST){
