...
<?php 
    ...
    $txtCapnhat = array_key_exists('txtCapnhat', $_POST) ? $_POST['txtCapnhat']: null;
                    ...
                    <div class="container-ad-items">
                        ...
                        if($_GET['ma'])
                        {
                            ...
                            <table class="tbsv">
                                <tr>
                                    <td>
                                        <h4>Mã sinh viên</h4> <input class="text" type="text" disabled readonly
                                            name="txtMaSinhVien" value="<?php echo $row2['MaSinhVien']; ?>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4>Tình trạng học</h4><input class="text" type="text" name="txtTinhTrangHoc"
                                            value="<?php echo $row2['TinhTrangHoc']; ?>">
                                    </td>
                                    <td>
